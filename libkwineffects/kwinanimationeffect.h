...
protected:
     ...
     */
    quint64 animate( EffectWindow *w, Attribute a, uint meta, int ms, FPx2 to, QEasingCurve curve = QEasingCurve(), int delay = 0, FPx2 from = FPx2(), bool keepAlive = true )
    { return p_animate(w, a, meta, ms, to, curve, delay, from, false, keepAlive); }
     ...
     */
    quint64 set( EffectWindow *w, Attribute a, uint meta, int ms, FPx2 to, QEasingCurve curve = QEasingCurve(), int delay = 0, FPx2 from = FPx2(), bool keepAlive = true )
    { return p_animate(w, a, meta, ms, to, curve, delay, from, true, keepAlive); }
...
private:
    quint64 p_animate( EffectWindow *w, Attribute a, uint meta, int ms, FPx2 to, QEasingCurve curve, int delay, FPx2 from, bool keepAtTarget, bool keepAlive );
