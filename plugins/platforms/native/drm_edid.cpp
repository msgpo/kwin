...
DrmEdid::DrmEdid(const void *data, uint32_t size)
{
...
bool DrmEdid::isValid() const
{
    return m_isValid;
}

QSize DrmEdid::physicalSize() const
{
    return m_physicalSize;
}

QByteArray DrmEdid::eisaId() const
{
    return m_eisaId;
}

QByteArray DrmEdid::monitorName() const
{
    return m_monitorName;
}

QByteArray DrmEdid::serialNumber() const
{
