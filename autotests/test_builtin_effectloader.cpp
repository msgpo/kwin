...
void TestBuiltInEffectLoader::testHasEffect_data()
{
    ...
    QTest::newRow("SlidingNotifications")           << QStringLiteral("slidingnotifications") << true;
...
void TestBuiltInEffectLoader::testSupported_data()
{
    ...
    QTest::newRow("SlidingNotifications")           << QStringLiteral("slidingnotifications") << true  << xc << true;
