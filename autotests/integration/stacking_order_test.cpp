...
private Q_SLOTS:
    ...
    void testTransientIsAlwaysAboveParent();
    void testRaiseTransientAndParent();

    void testGroupTransientIsAlwaysAboveWindowGroup();
    void testRaiseGroupTransientAndWindowGroup();
...
void StackingOrderTest::testTransientIsAlwaysAboveParent()
{
...
void StackingOrderTest::testRaiseTransientAndParent()
{
...
void StackingOrderTest::testGroupTransientIsAlwaysAboveWindowGroup()
{
...
void StackingOrderTest::testRaiseGroupTransientAndWindowGroup()
{
    const QRect geometry = QRect(0, 0, 128, 128);
    ...
    // If we activate the transient, only it will be raised.
    workspace()->activateClient(anotherClient);
    QTRY_VERIFY(anotherClient->isActive());
