...
TEST_DATA_XDG(testPositionDontAffect)
...
void TestShellClientRules::testPositionDontAffect()
{
    ...
    group.writeEntry("positionrule", 1);
...
TEST_DATA_XDG(testPositionApply)
...
void TestShellClientRules::testPositionApply()
{
    ...
    auto group = config->group("1");
    group.writeEntry("position", QPoint(42, 42));
    group.writeEntry("positionrule", 3);
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", 1);
    group.sync();
    ...
    // One should still be able to move the client.
...
TEST_DATA_XDG(testPositionRemember)
...
void TestShellClientRules::testPositionRemember()
{
    ...
    auto group = config->group("1");
    group.writeEntry("position", QPoint(42, 42));
    group.writeEntry("positionrule", 4);
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", 1);
    group.sync();
...
TEST_DATA_XDG(testPositionForce)
...
void TestShellClientRules::testPositionForce()
{
    ...
    auto group = config->group("1");
    group.writeEntry("position", QPoint(42, 42));
    group.writeEntry("positionrule", 2);
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", 1);
    group.sync();
    ...
    // Any attempt to move the client should not succeed.
    QSignalSpy clientStartMoveResizedSpy(client, &AbstractClient::clientStartUserMovedResized);
    QVERIFY(clientStartMoveResizedSpy.isValid());
    QCOMPARE(workspace()->getMovingClient(), nullptr);
    QVERIFY(!client->isMove());
...
TEST_DATA_XDG(testPositionApplyNow)
...
void TestShellClientRules::testPositionApplyNow()
{
    ...
    auto group = config->group("1");
    group.writeEntry("position", QPoint(42, 42));
    group.writeEntry("positionrule", 5);
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", 1);
    group.sync();
...
TEST_DATA_XDG(testPositionForceTemporarily)
...
void TestShellClientRules::testPositionForceTemporarily()
{
    ...
    auto group = config->group("1");
    group.writeEntry("position", QPoint(42, 42));
    group.writeEntry("positionrule", 6);
    group.writeEntry("wmclass", "org.kde.foo");
    group.writeEntry("wmclasscomplete", false);
    group.writeEntry("wmclassmatch", 1);
    group.sync();
...
TEST_DATA_XDG(testSizeDontAffect)
...
void TestShellClientRules::testSizeDontAffect()
{
    ...
    shellSurface.reset(qobject_cast<XdgShellSurface *>(createShellSurface(type, surface.data())));
...
void TestShellClientRules::testSizeApply()
{
    ...
    // TODO: KWin currently doesn't send the configure event when finished
    // resizing the client.
    // QVERIFY(configureRequestedSpy->wait());
...
TEST_DATA_XDG(testSizeRemember)
...
TEST_DATA_XDG(testSizeApplyNow)
...
TEST_DATA_XDG(testSizeForceTemporarily)
