...
#ifndef KWIN_EFFECTS_DISAPPEAR3_H
#define KWIN_EFFECTS_DISAPPEAR3_H
...
class Disappear3Effect : public Effect
{
public:
    Disappear3Effect();
...
inline
int Disappear3Effect::requestedEffectChainPosition() const
{
    return 50;
}
...
#endif // KWIN_EFFECTS_DISAPPEAR3_H
