...
#include "disappear3/disappear3.h"
...
EFFECT_FALLBACK
        ...
        QStringLiteral("appear2"),
        i18ndc("kwin_effects", "Name of a KWin Effect", "Appear 2"),
        i18ndc("kwin_effects", "Comment describing the KWin Effect", "Animate the appearing of windows"),
        QStringLiteral("Appearance"),
        QString("open-window"),
        QUrl(),
...
EFFECT_FALLBACK
        ...
        QStringLiteral("disappear1"),
        i18ndc("kwin_effects", "Name of a KWin Effect", "Disappear 1"),
...
EFFECT_FALLBACK
        ...
        QStringLiteral("disappear3"),
        i18ndc("kwin_effects", "Name of a KWin Effect", "Disappear 3"),
        i18ndc("kwin_effects", "Comment describing the KWin Effect", "Animate the disappearing of windows"),
        QStringLiteral("Appearance"),
        QString("close-window"),
        QUrl(),
        ...
        false,
#ifdef EFFECT_BUILTINS
        &createHelper<Disappear3Effect>,
        &Disappear3Effect::supported,
        nullptr
#endif
EFFECT_FALLBACK
    }, {
