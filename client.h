...
public:
    ...
    bool hasTransient(const Toplevel *c, bool indirect) const override;
...
private:
    ...
    void addTransient(Toplevel *transient) override;
    void removeTransient(Toplevel *transient) override;
