...
Q_SIGNALS:
    ...
    void pointerAxisChanged(KWin::InputRedirection::PointerAxis axis, qreal delta, qint32 discreteDelta, PointerAxisSource source, quint32 time, KWin::LibInput::Device *device);
